...
def draw_realistic_wave(time_factor):
    ...
    pygame.draw.line(screen, WHITE, (graph_x, graph_y + graph_height // 2), 
                     (graph_x + graph_width, graph_y + graph_height // 2), 2)  # X axis
    pygame.draw.line(screen, WHITE, (graph_x + graph_width // 2, graph_y), 
                     (graph_x + graph_width // 2, graph_y + graph_height), 2)  # Y axis

    # Generate and draw the wave
    ...
    # X-axis label
    x_axis_label = font.render("Time", True, WHITE)
    screen.blit(x_axis_label, (graph_x + graph_width - 50, graph_y + graph_height // 2 + 10))
    
    # Y-axis label
    y_axis_label = font.render("Amplitude", True, WHITE)
    screen.blit(y_axis_label, (graph_x + graph_width // 2 + 10, graph_y + 10))
    
    # Draw a small axis ticks
    for i in range(0, graph_width, graph_width // 10):
        pygame.draw.line(screen, WHITE, (graph_x + i, graph_y + graph_height // 2 - 5),
                         (graph_x + i, graph_y + graph_height // 2 + 5))
        
    for i in range(0, graph_height, graph_height // 10):
        pygame.draw.line(screen, WHITE, (graph_x + graph_width // 2 - 5, graph_y + i),
                         (graph_x + graph_width // 2 + 5, graph_y + i))
# Main loop
running = True
